...
class O2SequentialTest(unittest.TestCase):
    def _setup_modules(self):
        modules = OrderedDict(
            [("fc1", O2Linear(20, 30)), ("relu", O2ReLU()), ("fc2", O2Linear(30, 10))]
        )
        return modules

    def test_init(self):
        modules = self._setup_modules()
        O2Sequential(modules)
        O2Sequential(*modules.values())
    ...
    def test_set_chain_output_input_jacobian(self):
        o2seq = O2Sequential(
            O2Square(), O2Sequential(O2Square(), O2Square()), O2Square()
        )
    ...
    def test_set_chain_end_output_input_jacobian(self):
        o2seq = O2Sequential(O2Square(), O2Sequential(O2Square(), O2Square()))
    ...
    def test_get_chain_output_input_jacobian_cached(self):
        o2seq = O2Sequential(
            O2Square(),
            O2Sequential(
                O2Sequential(O2Square(), O2Square()),
                O2Sequential(O2Square()),
            ),
            O2Square(),
        )
    ...
    def test_backward(self):
        ...
        t = torch.rand(2, 6)
        o2seq = O2Sequential(
            O2Sequential(O2Square(), O2Sequential(O2Square())), O2Square()
        )
